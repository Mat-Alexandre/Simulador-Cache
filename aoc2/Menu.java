        ...
        switch (cache.getMapeamento()) {
            ...
            case "Associativo": {
                ...
                if (escrito == false) {
                    ...
                    linhaAux = linha;
                    tentativas = 0;
                    while (linhaAux < cache.get_pal_por_bloco() && tentativas < cache.get_pal_por_bloco()) {
                        if(CACHE[linhaAux].getValidade() == 1){
                            linhaAux++;
                        }
                        tentativas++;
                ...
                if(linhaAux < cache.getAssociatividade()){
                ...
                if (escrito == false) {
                    ...
                    if (cache.getSubstituicao() == "LRU") {
                        ...
                        if (tam > 0) {
                            linhaSubstituir = arraySub.get(tam - 1);
                        } else {
                            linhaSubstituir = 0;
                        }
                        ...
                        if (arraySub.size() > 0) {
                            arraySub.remove(arraySub.size() - 1);
                        }
            ...
            case "Total": {
                ...
                if (linhaAux >= cache.get_tam_cache()) {
                    linhaAux = linha;
                }
                ...
                if (escrito == false) {
                    ...
                    if (cache.getSubstituicao() == "LRU") {
                        ...
                        if (arraySub.size() > 0) {
                            linhaSubstituir = arraySub.get(arraySub.size() - 1);
                        } else {
                            linhaSubstituir = 0;
                        }
